...
using TChars = System.Collections.Generic.Dictionary<System.Int32,bb.SCharNet>;
using TQuestDBs = System.Collections.Generic.List<bb.SQuestDB>;
...
namespace bb
{
	...
	public class SUserBase : SUserCore
	{
		...
		public TimePoint CostumeListExpiredTime = default(TimePoint);
		...
		public override string StdName()
		{
			return 
				...
				SEnumChecker.GetStdName(CostumeListExpiredTime) + "," + 
		...
		public override string MemberName()
		{
			return 
				...
				SEnumChecker.GetMemberName(CostumeListExpiredTime, "CostumeListExpiredTime") + "," + 
	...
	public class SCharNet : SProto
	{
		...
		public SCharNet()
		{
			for (int iCostumeParts = 0; iCostumeParts < CostumeParts.Length; ++iCostumeParts)
				CostumeParts[iCostumeParts] = default(Int32);
		}
		...
		{
			return 
				SEnumChecker.GetStdName(CostumeParts);
		}
		public override string MemberName()
		{
			return 
				SEnumChecker.GetMemberName(CostumeParts, "CostumeParts");
		}
	}
	...
	public class SLoginNetSc : SProto
	{
		...
		public SLoginNetSc(SUserNet User_, TChars Chars_, TimePoint ServerTime_, TQuestDBs Quests_, TPackages Packages_, TCostumes Costumes_, TCostumes CostumeList_, Int32 RoomIdx_)
		{
			User = User_;
			Chars = Chars_;
		...
		public override void Push(CStream Stream_)
		{
			...
			Stream_.Pop(ref Costumes);
			Stream_.Pop(ref CostumeList);
		...
		public override void Pop(CStream Stream_)
		{
			...
			Stream_.Push(Costumes);
			Stream_.Push(CostumeList);
		...
		public override string StdName()
		{
			return 
				...
				SEnumChecker.GetStdName(Costumes) + "," + 
				SEnumChecker.GetStdName(CostumeList) + "," + 
		...
		public override string MemberName()
		{
			return 
				...
				SEnumChecker.GetMemberName(Costumes, "Costumes") + "," + 
				SEnumChecker.GetMemberName(CostumeList, "CostumeList") + "," + 
	...
	public class SSetCostumeNetSc : SProto
	{
		...
		{
			return 
				SEnumChecker.GetStdName(Codes);
		}
		public override string MemberName()
		{
			return 
				SEnumChecker.GetMemberName(Codes, "Codes");
		}
	}
	...
	public class SSingleBattleBeginNetSc : SBattleBeginNetSc
	{
		public SSingleBattleBeginNetSc()
		{
		}
		public SSingleBattleBeginNetSc(SSingleBattleBeginNetSc Obj_) : base(Obj_)
		{
		}
		public SSingleBattleBeginNetSc(SBattleBeginNetSc Super_) : base(Super_)
		{
		}
		public override void Push(CStream Stream_)
		{
		...
		public void Set(SSingleBattleBeginNetSc Obj_)
		{
			base.Set(Obj_);
		}
		public override string StdName()
	...
	public class SRewardDB : SProto
	{
		...
		public override string StdName()
		{
			return 
				...
				SEnumChecker.GetStdName(CostumeAdded);
		}
		public override string MemberName()
		{
			return 
				...
				SEnumChecker.GetMemberName(CostumeAdded, "CostumeAdded");
		}
	}
	...
	{
		public Int32 CostumeCode = default(Int32);
		public Int32 CharCode = default(Int32);
		...
		{
			return 
				SEnumChecker.GetStdName(CostumeCode) + "," + 
				SEnumChecker.GetStdName(CharCode);
		}
		public override string MemberName()
		{
			return 
				SEnumChecker.GetMemberName(CostumeCode, "CostumeCode") + "," + 
				SEnumChecker.GetMemberName(CharCode, "CharCode");
		}
	}
	...
	{
		public Int32 CharCode = default(Int32);
		public ECostumePart Part = default(ECostumePart);
		...
		{
			Stream_.Pop(ref CharCode);
			Stream_.Pop(ref Part);
		}
		public override void Push(JsonDataObject Value_)
		{
			Value_.Pop("CharCode", ref CharCode);
			Value_.Pop("Part", ref Part);
		}
		public override void Pop(CStream Stream_)
		{
			Stream_.Push(CharCode);
		...
		public override string MemberName()
		{
			return 
				SEnumChecker.GetMemberName(CharCode, "CharCode") + "," + 
				SEnumChecker.GetMemberName(Part, "Part");
		}
	}
