...
namespace rso.physics
{
    ...
    public abstract class CCollider2D : CObject2D
    {
        ...
        public abstract bool checkOverlapped(Int64 tick, CMovingObject2D movingObject, CCollider2D otherCollider);
        public abstract bool checkOverlapped(Int64 tick, CMovingObject2D movingObject, CCollider2D otherCollider, CMovingObject2D otherMovingObject);
        public abstract bool checkOverlapped(Int64 tick, CMovingObject2D movingObject, CRectCollider2D otherRectCollider);
        public abstract bool checkOverlapped(Int64 tick, CRectCollider2D otherRectCollider, CMovingObject2D otherMovingObject);
        public abstract bool checkOverlapped(Int64 tick, CMovingObject2D movingObject, CRectCollider2D otherRectCollider, CMovingObject2D otherMovingObject);
    }
}
